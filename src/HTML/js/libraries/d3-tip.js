!(function (t, e) {
  "object" == typeof exports && "undefined" != typeof module
    ? (module.exports = e(require("d3-collection"), require("d3-selection")))
    : "function" == typeof define && define.amd
    ? define(["d3-collection", "d3-selection"], e)
    : ((t.d3 = t.d3 || {}), (t.d3.tip = e(t.d3, t.d3)));
})(this, function (l, i) {
  "use strict";
  return function () {
    var u = function () {
      ...
      (e = t.node()),
        (r = e
          ? "svg" === e.tagName.toLowerCase()
            ? e
            : e.ownerSVGElement
          : null) && ((y = r.createSVGPoint()), p.appendChild(n));
    }
    (h.show = function () {
      ...
      var e,
        ...
        l = v(),
        i = x.length,
        s = document.documentElement.scrollTop || p.scrollTop,
        f = document.documentElement.scrollLeft || p.scrollLeft;
      ...
      return (
        ...
        l
          .classed(o, !0)
          .style("top", e.top + r[0] + s + "px")
          .style("left", e.left + r[1] + f + "px"),
        h
      );
    }),
      (h.hide = function () {
        return v().style("opacity", 0).style("pointer-events", "none"), h;
      }),
      (h.attr = function (t, e) {
        if (arguments.length < 2 && "string" == typeof t) return v().attr(t);
        var n = Array.prototype.slice.call(arguments);
        return i.selection.prototype.attr.apply(v(), n), h;
      }),
      (h.style = function (t, e) {
        if (arguments.length < 2 && "string" == typeof t) return v().style(t);
        var n = Array.prototype.slice.call(arguments);
        return i.selection.prototype.style.apply(v(), n), h;
      }),
      (h.direction = function (t) {
        return arguments.length ? ((u = null == t ? t : o(t)), h) : u;
      }),
      (h.offset = function (t) {
        return arguments.length ? ((c = null == t ? t : o(t)), h) : c;
      }),
      (h.html = function (t) {
        return arguments.length ? ((a = null == t ? t : o(t)), h) : a;
      }),
      (h.rootElement = function (t) {
        return arguments.length ? ((p = null == t ? t : o(t)), h) : p;
      }),
      (h.destroy = function () {
        return n && (v().remove(), (n = null)), h;
      });
    var m = l.map({
        n: function () {
          var t = e(this);
    ...
    function v() {
      return null == n && ((n = t()), p.appendChild(n)), i.select(n);
    }
    function e(t) {
